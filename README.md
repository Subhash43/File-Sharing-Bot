...
* `CUSTOM_CAPTION` put your Custom caption text if you want Setup Custom Caption, you can use HTML and <a href='https://github.com/Subhash43/File-Sharing-Bot/blob/main/README.md#custom_caption'>fillings</a> for formatting (only for documents)
...
## Support   
Join Our [Telegram Group](https://www.telegram.dog/Subhash43) For Support/Assistance And Our [Channel](https://www.telegram.dog/Subhash43) For Updates.   
...
[FILE-SHARING-BOT](https://github.com/Subhash43/File-Sharing-Bot/) is Free Software: You can use, study share and improve it at your
